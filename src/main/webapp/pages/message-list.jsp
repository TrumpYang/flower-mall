    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/role/findAll.do">公告管理</a></li>
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='${pageContext.request.contextPath}/pages/message.jsp'">
                                        <i class="fa fa-file-o"></i> 新建网站公告
                                    </button>
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (i, result) {
                            ...
                            item =
                                ...
                                "<td>" + result['status'] + "</td>" +
                                "<td>" + "<button class=\"btn bg-olive btn-xs\">撤销</button>" + "</td>" +
                                "</tr>";
